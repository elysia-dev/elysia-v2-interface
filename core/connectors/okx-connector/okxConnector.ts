...
type OkxProvider = Provider & {
  ...
  on?:
    | ((method: string, listener: (...args: any[]) => void) => void)
    | undefined
  removeListener?:
    | ((method: string, listener: (...args: any[]) => void) => void)
    | undefined
...
export class OkxWalletError extends Error {
  public constructor() {
    ...
    this.name = OkxWalletError.name
    Object.setPrototypeOf(this, OkxWalletError.prototype)
  }
}
...
export class OkxWallet extends Connector {
  ...
  private async isomorphicInitialize(): Promise<void> {
    ...
    this.provider = window.okxwallet as OkxProvider
    if (this.provider) {
  ...
  public async activate(
    ...
    return this.isomorphicInitialize()
      .then(async () => {
        if (!this.provider) throw new OkxWalletError()
